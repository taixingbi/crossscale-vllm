...
with (root/'suite.lock').open('a') as lock:
    ...
    dest = root/'diagnosis-prefill-2048'
    ...
    args[args.index('--max-num-batched-tokens')+1] = '2048'
    ...
    try:
        study.event('prefill-2048-rollout-start')
        ...
        study.event('prefill-2048-diagnostic-start')
        results=[]
        for rep in range(3):
        ...
        study.event('prefill-2048-diagnostic-complete',output=str(dest))
    finally:
        ...
        study.event('prefill-2048-diagnostic-restored')
